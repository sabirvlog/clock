setInterval(setClock,1000) /*we set the interval for a certain function because we want to call a certain function every second and we are just going to call this set o'clock for every 1000 miliseconds we are going to call this function. */
